...
export default function UiToiUuPage() {
  return (
    <>
      <Header />
      ...
      <main className="min-h-screen bg-white text-slate-800">
        ...
        <section className="py-20 px-6 max-w-5xl mx-auto text-center">
          ...
          >
            Một UI tối ưu không chỉ giúp website trông chuyên nghiệp mà còn cải
            thiện trải nghiệm người dùng, giảm tỉ lệ thoát và tăng chuyển đổi.
          </motion.p>
        </section>
            ...
            {[
              {
                ...
                text: "Font chữ quá nhỏ, thiếu tương phản màu sắc.",
              },
              {
                icon: <FaTimesCircle size={28} className="text-red-500" />,
                text: "Bố cục rối rắm, không theo grid chuẩn.",
              },
              {
                icon: <FaTimesCircle size={28} className="text-red-500" />,
                text: "Điều hướng khó tìm, UX kém.",
              },
              {
                icon: <FaTimesCircle size={28} className="text-red-500" />,
                text: "Thiếu alt text cho ảnh, không hỗ trợ accessibility.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <section className="py-20 px-6 max-w-4xl mx-auto">
          ...
          <ul className="space-y-4">
            {[
              ...
              "Contrast màu đạt chuẩn WCAG.",
              "Font dễ đọc, tối thiểu 16px.",
              "Navigation rõ ràng, dễ hiểu.",
              "Alt text đầy đủ cho hình ảnh.",
            ].map((item, i) => (
              <motion.li
                key={i}
                initial={{ opacity: 0, x: -20 }}
        ...
        <section className="py-16 px-6 bg-gray-100">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                {
                  q: "Tối ưu UI có làm chậm website không?",
                  a: "Không, nếu được thực hiện đúng cách, tối ưu UI còn giúp website load nhanh hơn nhờ bố cục gọn gàng.",
                },
                {
                  q: "UI Optimization khác gì với UX?",
                  a: "UI tập trung vào giao diện (màu sắc, font, layout), còn UX liên quan đến toàn bộ trải nghiệm người dùng.",
                },
                {
                  q: "Có cần kết hợp với SEO không?",
                  a: "Có, UI tối ưu giúp giảm bounce rate, hỗ trợ SEO hiệu quả hơn.",
                },
              ].map((faq, i) => (
                <motion.div
                  key={i}
        ...
        <section className="py-20 px-6 text-center bg-blue-600 text-white">
          ...
          <p className="mb-6">
            Sau khi tối ưu UI, hãy đảm bảo website của bạn chuẩn SEO kỹ thuật để
            bứt phá hiệu suất.
          </p>
          <Link
            href="/seo-ky-thuat"
